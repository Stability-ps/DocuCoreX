...
export const STALE_PROCESSING_NOTICE = "No heartbeat update for a while — this run may be stuck. You can cancel or force reprocess.";
export const STALE_PROCESSING_THRESHOLD_MS = 600_000;
