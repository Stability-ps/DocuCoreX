...
export function PwaInstaller() {
  ...
  useEffect(() => {
    ...
    if (standalone || localStorage.getItem("docucorex_install_dismissed") === "true") return;
  ...
  return (
    <div className="fixed inset-x-4 bottom-[calc(5.5rem+env(safe-area-inset-bottom))] z-50 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl md:hidden">
      ...
      <p className="mt-1 text-xs font-semibold leading-5 text-slate-500">
        {showIosHint ? "On iPhone, tap Share, then Add to Home Screen." : "Add DocuCoreX to your home screen for a native app experience."}
      </p>
