      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {intakeTypes.map((type) => (
          ...
          >
            ...
            <h2 className="mt-5 text-lg font-black text-navy-950">{type.title}</h2>
            <p className="mt-2 text-sm leading-6 text-slate-500">{type.detail}</p>
            <div className="mt-5 flex items-center gap-2 text-xs font-black uppercase tracking-[0.14em] text-emerald-700">
