...
function DisabledAction({ children }: { children: React.ReactNode }) {
  return (
    <button
      ...
      className="inline-flex cursor-not-allowed items-center justify-center rounded-2xl bg-slate-200 px-4 py-3 text-sm font-semibold text-slate-500"
    >
      {children}
    </button>
  );
        ...
        <section className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <h2 className="mt-4 text-3xl font-semibold text-navy-950">Free Plan</h2>
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-amber-950">Stripe setup required</h3>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <article key={label as string} className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-4 text-2xl font-semibold text-navy-950">{value as string}</p>
              <p className="mt-1 text-sm font-semibold text-slate-700">{label as string}</p>
        ...
        <div className="grid gap-6 xl:grid-cols-2">
          ...
          <SectionPanel title="Payment Method" description="Payment controls are disabled until Stripe checkout is configured.">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              ...
              <p className="mt-4 font-semibold text-navy-950">No payment method on file</p>
