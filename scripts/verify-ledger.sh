...
results=$(mktemp)
for f in 21_core 22_guards 23_integrity 24_remaining 26_gate 27_reporting 28_reconciliation 29_vat 30_period_close 31_fixed_assets 32_receivables_payables; do
